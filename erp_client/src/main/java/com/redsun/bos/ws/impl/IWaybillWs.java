...
public interface IWaybillWs {
    ...
    @RequestWrapper(localName = "getWaybilldetailList", targetNamespace = "http://ws.bos.redsun.com/", className = "com.redsun.bos.ws.GetWaybilldetailList")
    @ResponseWrapper(localName = "getWaybilldetailListResponse", targetNamespace = "http://ws.bos.redsun.com/", className = "com.redsun.bos.ws.GetWaybilldetailListResponse")
