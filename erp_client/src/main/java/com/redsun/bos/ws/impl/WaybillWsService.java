 ...
 * 
 */
@WebServiceClient(name = "WaybillWsService", targetNamespace = "http://impl.ws.bos.redsun.com/", wsdlLocation = "http://localhost:9090/bos/cxf/waybillWs?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9090/bos/cxf/waybillWs?wsdl");
